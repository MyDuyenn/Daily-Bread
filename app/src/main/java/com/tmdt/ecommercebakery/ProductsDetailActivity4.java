...
public class ProductsDetailActivity4 extends AppCompatActivity implements RatingDialogListener {
    ...
    private void showRatingDialog() {
        new AppRatingDialog.Builder()
                ...
                .create(ProductsDetailActivity4.this)
                .show();
    ...
    public void onPositiveButtonClicked(int value, String s) {
        ...
        ratingTbl.child(Prevalent.currentOnlineUser.getPhone()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(ProductsDetailActivity4.this, "Thank you for submit rating !!!", Toast.LENGTH_SHORT).show();
            }
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                Intent intent = new Intent(ProductsDetailActivity4.this, ProductScreen.class);
